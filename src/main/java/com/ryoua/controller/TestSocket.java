...
public class TestSocket {
    ...
    private static CopyOnWriteArraySet<TestSocket> webSockets =new CopyOnWriteArraySet<>();
    ...
    public void sendAllMessage(String message) {
        for(TestSocket webSocket : webSockets) {
    ...
    public void sendOneMessage(String shopId, Integer message) {
        Session session = sessionPool.get(shopId);
        if (session != null) {
            try {
